...
from sr.comp.matches import MatchSchedule, Match
...
FIRST_MATCH = Match(0, 'A', ["0A"], dtime(13, 0), dtime(13, 5), 'league')
SECOND_MATCH = Match(1, 'A', ["1A"], dtime(13, 6), dtime(13, 11), 'league')
THIRD_MATCH = Match(2, 'A', ["2A"], dtime(13, 11), dtime(13, 16), 'league')
